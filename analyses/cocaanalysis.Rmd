...
longsums %>%
  ...
  geom_pointrange(aes(ymin = ci_lower, ymax = ci_upper)) +
  ggtitle("Summed neighbors weighted by similarity to long")
```
...
shortsums %>%
  ggplot(aes(x = spacetime, y = empirical_sum)) +
  geom_pointrange(aes(ymin = ci_lower, ymax = ci_upper)) +
  ggtitle("Summed neighbors weighted by similarity to short")
```
...
ggplot(nullTimeDF, aes(x=nullTime)) +
  ...
  theme_classic() +
  geom_text(aes(x=observedTimeLong, label="long", y=4000), 
            colour="blue", text=element_text(size=11)) +
  geom_text(aes(x=observedTimeShort, label="short", y=4000), 
...
ggplot(nullSpaceDF, aes(x=nullSpace)) +
  ...
  geom_vline(xintercept = observedSpaceShort, linetype="dotted", 
                color = "green", size=1.5) +
  geom_text(aes(x=observedSpaceLong, label="long", y=4000), 
            colour="blue", text=element_text(size=11)) +
  geom_text(aes(x=observedSpaceShort, label="short", y=4000), 
            colour="green", text=element_text(size=11))
```
...
```{r}
  ...
  geom_vline(xintercept = observedDiffLong, linetype="dotted", 
    ...
    geom_vline(xintercept = observedDiffShort, linetype="dotted", 
                color = "green", size=1.5) +
  geom_text(aes(x=observedDiffLong, label="long", y=4000), 
            colour="blue", text=element_text(size=11)) +
  geom_text(aes(x=observedDiffShort, label="short", y=4000), 
            colour="green", text=element_text(size=11))
```
