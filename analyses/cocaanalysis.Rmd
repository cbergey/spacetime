...
Below: A plot of weighted sums of space, time, both and other words for "long" within the closest 20, 100, and 500 neighbors. The numbers on the plot denote the number of words of that type in that range of neighbors.
...
Below: A plot of weighted sums of space, time, both and other words for "short" within the closest 20, 100, and 500 neighbors. The numbers on the plot denote the number of words of that type in that range of neighbors.
